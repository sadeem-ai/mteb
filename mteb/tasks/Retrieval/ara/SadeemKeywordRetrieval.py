...
class SadeemKeywordRetrieval(AbsTaskRetrieval):
    ...
    metadata = TaskMetadata(
        ...
        dialect=[],
        text_creation="found",
        bibtex_citation="""@misc{soliman2024sadeem,
                            author       = {Abu Bakr Soliman},
                            title        = {Sadeem Arabic Keywords Retrieval: An Evaluation Benchmark Dataset for Arabic Keywords-Based Retrieval Tasks},
                            year         = {2024},
                            url          = {https://huggingface.co/datasets/sadeem-ai/sadeem-ar-eval-retrieval-keywords},
                            note         = {Huggingface}
                            }
                            """,
